...
class ParentProfil extends StatelessWidget {
  ParentProfil({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(47.0, 1197.0),
            child: Text(
              'You need to pay the \nsubscribtion before 1st mars',
              style: TextStyle(
                fontFamily: 'Gotham',
                fontSize: 24,
                color: const Color(0xff000000),
...
const String _svg_7r53b =
    '<svg viewBox="20.5 706.5 350.0 1.0" ><path transform="translate(20.5, 706.5)" d="M 0 0 L 350 0" fill="none" stroke="#707070" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_rorgwr =
    '<svg viewBox="20.5 1089.5 350.0 1.0" ><path transform="translate(20.5, 1089.5)" d="M 0 0 L 350 0" fill="none" stroke="#707070" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
