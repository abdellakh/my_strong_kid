    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(43.0, 235.0),
            child: SizedBox(
              width: 292.0,
              height: 42.0,
              child: Text(
                '''Step 3 : Enter your kid information''',
                style: TextStyle(
                  fontFamily: 'Gotham',
                  fontSize: 20,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(43.6, 812.0, 59.0, 56.0),
            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(50.0, -35.0, 200.0, 50.0),
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(79.0, -20.0, 90.0, 50.0),
