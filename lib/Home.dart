          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                  ...
                  colors: [Color(0xffA17EBB), Color(0xffF3E8F3)]),
            ),
          ),
          Transform.translate(
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: const Color(0xffF3E8F3).withOpacity(.7),
                    border:
                    ...
                    Pinned.fromSize(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(22.0, 49.8, 96.0, 96.0),
                            size: Size(140.0, 145.8),
                            fixedWidth: true,
                            fixedHeight: true,
                            child:
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image:
                                      const AssetImage('assets/images/kid.png'),
                                  fit: BoxFit.fill,
                                ),
                              ),
                            ),
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(45.0, 16.0, 50.0, 33.0),
                            size: Size(140.0, 54.2),
                            fixedWidth: true,
                            fixedHeight: true,
                            child: Text(
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(35.5, 58.2, 73.0, 73.0),
                      size: Size(140.0, 148.7),
                      fixedWidth: true,
                      fixedHeight: true,
                      child:
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: const AssetImage('assets/images/hooome.png'),
                            fit: BoxFit.fill,
                          ),
                        ),
                      ),
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(34.0, 17.0, 69.0, 33.0),
                            size: Size(140.0, 54.2),
                            fixedWidth: true,
                            fixedHeight: true,
                            child: Text(
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(36.0, 62.7, 69.0, 68.0),
                      size: Size(140.0, 148.7),
                      fixedWidth: true,
                      fixedHeight: true,
                      child:
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: const AssetImage('assets/images/karate.png'),
                            fit: BoxFit.fill,
                          ),
                        ),
                      ),
                  ...
                  Pinned.fromSize(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(25.0, 17.1, 89.0, 33.0),
                          size: Size(140.0, 54.2),
                          fixedWidth: true,
                          fixedHeight: true,
                          child: Text(
